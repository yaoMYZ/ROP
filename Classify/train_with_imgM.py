...
class Train:
    ...
    def __contruct_model(self):
        ...
        self.__rate = self.__train_conf['training_para']['rate']
    ...
    def train(self):
        ...
        for epoch in range(n_epochs):  # loop over the dataset multiple times
            ...
            for step in range(self.__data_mgr.get_train_batch_num()):
                ...
                outputs = self.__model(x_train, img_train,self.__rate)
    ...
    def __test_step(self):
        ...
        for step in range(self.__data_mgr.get_test_batch_num()):
            ...
            # forward
            outputs = self.__model(x_test, img_test,self.__rate)
            # statistics
